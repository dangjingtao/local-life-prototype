...
| T037 | Mobile 自提双凭证 | Mobile / Fulfillment | DOING | 0.3.0 | T034、T018 | `task/T037-mobile-pickup-dual-credential` 施工中；消费 T034 Shared credential / redemption；同一订单二维码 + 数字码，未生效 / 可核销 / 已失效；不改 PC |
