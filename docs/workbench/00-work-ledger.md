...
2. T008 已进入 REVIEW；T009-T011 可继续以已落地的角色壳为施工基线，T008 的正式 PASS 仍需补 1440px / 1024px 视觉验收。
3. Mobile T004-T007 仍需满足 T003 前置；PC T009-T011 应继续遵守 T008 的角色与数据范围边界。
4. 页面完成后执行 T012 五态、可访问性和多视口质量检查。
5. 由 T013 串联三条主流程并核对 AC-001 至 AC-010，再将 T001 推进到 REVIEW。
6. 未确认的产品规则在施工中暂停并向用户确认。
