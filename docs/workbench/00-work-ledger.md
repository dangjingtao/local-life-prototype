...
| T044 | V0.3 数字取货码语义整改 | Shared / Mobile / PC / Fulfillment / Release Gate | REVIEW | 0.3.0 | T034、T037-T039 | PR #43；core pickupCode=`482731`，order/credential/redemption 三处同值；Verify #34047758811 success；Browser #34047758808：T022/T034/T037/T038/T039 均通过，全量 124/132，仅余既有 8 个 checkout 回归；CodeRabbit Major 已修复并 resolve、latest success |
