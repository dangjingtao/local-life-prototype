...
| T019 | Mobile 线上商城中高保真购买闭环 | Mobile / UX | REVIEW | 0.2.0 | T015、T016 | 原 PR #13 / CI / 2026-08-31 验收证据保留；2026-09-02 用户视觉验收重开。首页 R1 已形成 browsing-first 新基线；T019-R2 商品详情 PR #23 已完成 UX 自审并进入 REVIEW，父卡在商城全链视觉确认前不恢复 PASS |
...
- T019 商城 UX 已进入返工 lane：首页 R1 已建立 browsing-first 基线；T019-R2 商品详情 PR #23 已完成结构、几何、购买栏和消费者文案返工，UX 自审 `PASS FOR MERGE`，父卡保持 REVIEW 等待全链视觉确认。
...
- T019 线上商城购买闭环 — `REVIEW`（2026-09-02 UX reopen；T019-R2 PR #23 review）。
- T020 智慧抗衰预约 / 核销 — `PASS`。
...
- T019-R2 商品详情视觉返工 — `REVIEW`，PR #23；可合入 `dev` 作为商详新基线，但不单独恢复 T019 PASS。
...
1. T019-R2 PR #23 完成最终 review / 回归后合入 `dev`；父卡 T019 保持 REVIEW，继续收口商城购物车、结算、订单视觉后再做全链验收。
...
4. T022-T024 稳定后进入 T025；T025 与 T030 都完成后再执行 T026 总体跨端验收准备。