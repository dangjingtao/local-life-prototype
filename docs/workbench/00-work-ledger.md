...
| T041 | Mobile 商城积分消费闭环 | Mobile / Mall / Benefits | DOING | 0.3.0 | T034、T019/T033 当前消费者基线 | `task/T041-mobile-mall-points-loop` 施工中；商城购物车可得积分 + checkout Candidate 积分抵现 / 金额联动；冻结 storefront-free 消费者语义 |
