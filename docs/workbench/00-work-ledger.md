...
| T044 | V0.3 数字取货码语义整改 | Shared / Mobile / PC / Fulfillment / Release Gate | DOING | 0.3.0 | T034、T037-T039 | PRD R02 反向审查发现：当前 `pickupCode=LL-1024` 与“数字取货码”语义不一致；需收口为纯数字，并保持 order / credential / redemption 同值、双通道互斥 |
