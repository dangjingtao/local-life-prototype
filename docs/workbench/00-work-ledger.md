...
| T036 | Mobile 便利店分类滚动联动 | Mobile / Interaction | REVIEW | 0.3.0 | T035 | PR #32 已完成实现与首轮 review；T036 专项 5/5、T035 4/4、Verify #331 success；2026-09-06 发现旧分支落后最新 dev，已将已审实现重放到 `dev@3a5d0b9`，等待 latest-head CI / review 复核 |
...
3. V0.3：T034、T035 已 PASS；当前可并行启动 T036、T037、T040、T041、T042。
