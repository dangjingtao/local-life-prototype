...
3. T008、T009 已进入 REVIEW；T010-T011 可继续复用 PC 角色壳与权限边界，T008/T009 正式 PASS 仍需补 1440px / 1024px 视觉验收。
4. Mobile T005-T007 可继续复用 T003 壳、T004 已接入的门店入口结构和 `@prototype/shared`；T006 应复用 `EXPERIENCE-8888-01` / `CARE-8888` 跨端凭证，不另造同义数据。
