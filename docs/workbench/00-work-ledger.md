...
| T019 | Mobile 线上商城中高保真购买闭环 | Mobile / UX | REVIEW | 0.2.0 | T015、T016 | 原 PR #13 / CI / 2026-08-31 验收证据保留；2026-09-02 用户视觉验收重开。R1 首页已稳定；R2 商品详情 PR #23 merge `da635596`；T019-R3 商城购物车视觉返工 `DOING`，父卡在 R5 全链视觉确认前不恢复 PASS |
...
- T019 商城 UX 返工继续串行：R1 首页已稳定；R2 商品详情 PR #23 已 merge `dev`；R3 商城购物车视觉返工现为 `DOING`，完成 UX 自审 / review 后再进入 R4。
...
- T019 线上商城购买闭环 — `REVIEW`（2026-09-02 UX reopen；R3 active）。
- T020 智慧抗衰预约 / 核销 — `PASS`。
...
- T019-R3 商城购物车视觉返工 — `DOING`；严格按 Screen C 施工并保留 storefront 独立购物车语义。
- T019-R4 结算确认 + 订单物流视觉返工 — 等待 R3 整合。
...
1. T019-R3 完成 Screen C 购物车施工、UX 自审、browser regression 和 PR review 后合入 `dev`，再进入 R4。
