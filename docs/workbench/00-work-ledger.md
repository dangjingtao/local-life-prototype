...
| T041 | Mobile 商城积分消费闭环 | Mobile / Mall / Benefits | REVIEW | 0.3.0 | T034、T019/T033 当前消费者基线 | PR #40；reviewed code `c87839d`；Verify #34007147259 success；Browser #34007147233：T041 4/4、T019-R4 2/2、R5 1/1、全量 116/124，余 8 项为既有 checkout 债；CodeRabbit success / 无 actionable comment，自审无阻塞 |
