...
export const v02Orders: Order[] = [
  ...
  { id: "CONV-YUNLING-8888-PICKUP", userId: CORE_DEMO_IDS.user, scene: "store", status: "pending_fulfillment", fulfillment: "pickup", fulfillmentDetail: { mode: "pickup", status: "preparing", storeId: CORE_DEMO_IDS.store, pickupWindow: "今天 13:30-14:00", pickupCode: "PK-8888" }, storeId: CORE_DEMO_IDS.store, items: [{ kind: "product", id: "PRODUCT-OAT-LATTE", name: "燕麦拿铁", quantity: 2, unitPriceYuan: 11.9 }, { kind: "product", id: "PRODUCT-EGG-SANDWICH", name: "鸡蛋三明治", quantity: 1, unitPriceYuan: 12.8 }], amountYuan: 36.6, createdAt: "2026-09-05T13:10:00+08:00" },
  { id: "CONV-YUNLING-8888-DELIVERY", userId: CORE_DEMO_IDS.user, scene: "store", status: "pending_fulfillment", fulfillment: "store_delivery", fulfillmentDetail: { mode: "short_delivery", status: "preparing", storeId: CORE_DEMO_IDS.store, deliveryAddress: "广州市天河区云岭路 12 号 802 房", distanceKm: 1.2, estimatedMinutes: 20 }, storeId: CORE_DEMO_IDS.store, items: [{ kind: "product", id: "PRODUCT-OAT-LATTE", name: "燕麦拿铁", quantity: 2, unitPriceYuan: 11.9 }, { kind: "product", id: "PRODUCT-EGG-SANDWICH", name: "鸡蛋三明治", quantity: 1, unitPriceYuan: 12.8 }], amountYuan: 36.6, createdAt: "2026-09-05T13:15:00+08:00" },
